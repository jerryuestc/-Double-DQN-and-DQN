...
dparam=0.00005 #decay parameter
...
for idx,i in enumerate(range(int(num_epochs))):
    ...
    while(1):
        ...
        u,v=updateweights(replay) #updating the weights by calling experience replay function.
        ...
        if cnt%tnuf==0: #update every tnuf steps
